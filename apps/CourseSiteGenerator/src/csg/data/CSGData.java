...
import static csg.CSGPropertyType.LABS_TABLE;
import static csg.CSGPropertyType.LECTURES_TABLE;
...
import static csg.CSGPropertyType.RECITATION_TABLE;
...
public class CSGData implements AppDataComponent {
    ...
    ObservableList<Lab> lab;
    ObservableList<ScheduleObject> schedule;
    ...
    public CSGData(CSGApp initApp) {
        ...
        //NOW FOR THE MEETING TAB. GET THE LIST OF ITEMS FROM THE LECTURE, RECITATION AND LAB TABLES
        TableView<Lecture> lectureTableView = (TableView)gui.getGUINode(LECTURES_TABLE);
        lectures = lectureTableView.getItems();
        
        TableView<Recitation> recitationTableView = (TableView)gui.getGUINode(RECITATION_TABLE);
        recitation = recitationTableView.getItems();
        
        TableView <Lab> labTableView = (TableView) gui.getGUINode(LABS_TABLE);
        lab = labTableView.getItems();
        
        TableView<ScheduleObject> scheduleTableView = (TableView) gui.getGUINode(CSGPropertyType.SCHEDULE_ITEMS_TABLE);
    ...
    public void addRecitation(Recitation r){
        this.recitation.add(r);
    }
    
    public void removeRecitation(Recitation r){
        this.recitation.remove(r);
    }
    ...
    public void removeScheduleObject(ScheduleObject o){
        this.schedule.remove(o);
    }
    ...
    public Iterator<ScheduleObject> scheduleIterator(){
