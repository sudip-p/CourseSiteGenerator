...
public class AppNodesBuilder {
    ...
    public ImageView buildImageView(Object nodeId,
            String path,
            GridPane parent, int col, int row, int colSpan,
            int rowSpan, String styleClass,
            boolean enabled){
        
        ImageView img = new ImageView(path);
        
        initNode(nodeId, img, parent, col, row, colSpan, rowSpan, styleClass, enabled);        
    ...
    public Button buildIconButton(Object nodeId,
            ...
            String styleClass,
            boolean enabled){
        Button button = buildTextButton(nodeId, parent, col, row, colSpan, rowSpan, styleClass, enabled);
    ...
    public DatePicker buildDatePicker(Object nodeId,
        ...
        initNode(nodeId, dp, styleClass, enabled);
        
        PropertiesManager.getPropertiesManager().addProperty(dp, nodeId.toString());
    ...
    public Tab buildTab(Object nodeId,
            ...
            boolean enabled){
        Tab tab = new Tab();
        tab.setText(PropertiesManager.getPropertiesManager().getProperty(nodeId));
    ...
    public TabPane buildTabPane(Object nodeId,
        ...
        this.initNode(nodeId, tabPane, parentPane, styleClass, enabled);
    ...
    public TextArea buildTextArea(Object nodeId,
        ...
        initNode(nodeId, ta, parentPane, styleClass, enabled);
        initPromptNode(nodeId, ta);
        return ta;
    }
    ...
    public TitledPane buildTitledPane(Object nodeId,
        ...
        initNode(nodeId, titledPane, parentPane, styleClass, enabled);
        initLabeledNode(nodeId, titledPane);
        return titledPane;
    }
    ...
    initNode(nodeId, ta, parent, col, row, colSpan, rowSpan, styleClass, enabled);
