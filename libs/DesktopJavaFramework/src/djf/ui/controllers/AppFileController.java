        ...
        try {
            ...
            if (continueToMakeNew) {
                ...
                if (props.isTrue(HAS_NEW_DIALOG)) {
                    ...
                    GridPane bannerGridPane = (GridPane)(app.getGUIModule().getGUINode("BANNER_GRIDPANE"));
                    HBox pages = (HBox)(app.getGUIModule().getGUINode("PAGES_HBOX"));
                    GridPane instructorPane = (GridPane)(app.getGUIModule().getGUINode("INSTRUCTOR_GRIDPANE"));
                    ImageView faviconIV = (ImageView)(app.getGUIModule().getGUINode("FAVICON_IV"));
                    ImageView navBarIV = (ImageView)(app.getGUIModule().getGUINode("NAVBAR_IV"));
                    ImageView leftIV = (ImageView)(app.getGUIModule().getGUINode("LEFT_IV"));
                    ImageView rightIV = (ImageView)(app.getGUIModule().getGUINode("RIGHT_IV"));
                    bannerGridPane.getChildren().forEach((node) -> {
                    ...
                    pages.getChildren().forEach(node -> {
                        if(node instanceof CheckBox){
                            ((CheckBox) node).setSelected(false);
                        }
                    }); 
                    faviconIV.setImage(new Image("file:.\\images\\white_shield.png"));
                    navBarIV.setImage(new Image("file:.\\images\\SBUDarkRedShieldLogo.png"));
                    leftIV.setImage(new Image("file:.\\images\\SBUWhiteShieldLogo.jpg"));
                    rightIV.setImage(new Image("file:.\\\\images\\\\SBUCSLogo.png"));
                    
                    instructorPane.getChildren().forEach(node -> {
                        if(node instanceof TextField){
                            ((TextField)node).clear();
                        }
